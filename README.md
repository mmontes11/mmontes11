...
- 🦭 Maintaining [mariadb-operator](https://github.com/mariadb-operator).
- ☁️ Working with Kubernetes and Go.
- 🌱 Contributing to open source.
- 🚀 Deploying [stuff](https://github.com/mmontes11/k8s-infrastructure) on my [homelab](https://github.com/mmontes11/k8s-management).
